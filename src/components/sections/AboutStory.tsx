    ...
    <section className="py-20 bg-brand-cream/35 text-brand-forest-green">
      <div className="max-w-5xl mx-auto px-4 text-center space-y-12">
        ...
        <div className="max-w-3xl mx-auto text-sm md:text-base leading-relaxed text-brand-forest-green/80 font-sans space-y-4 text-left md:text-center">
          <p>
            Rumah Produksi Nilam lahir sebagai langkah nyata hilirisasi riset wirausaha mahasiswa Fakultas Pertanian Universitas Brawijaya. Didukung penuh oleh program Brawijaya Startup Action 2026, kami berkomitmen mengangkat kearifan botani lokal demi kesejahteraan petani nilam di Malang, Jawa Timur.
          </p>
          <p>
